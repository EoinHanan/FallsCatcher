...
public class Api {
    private static final String ROOT_URL = "http://10.52.54.189/FallsApi/v1/Api.php?apicall=createfall";    public static final String URL_CREATE_FALL = ROOT_URL + "createfall";
